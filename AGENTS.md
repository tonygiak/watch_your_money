...
| **Last delivered to users** | Login (Supabase native phone OTP), Insights (period totals + by-category + top merchants + top products), encrypted offline cache, runnable Scanner — all Greek-first. The §2.8 MVP is now reachable end-to-end on a real device with only freelancer-mode (bullets 8 + 9) left to ship.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| **Next sprint**             | **S-005 — discovery (`freelancer-mode`)**. Settles the contracts for the freelancer flow: tag-as-business UX (inline on Receipt detail vs Profile-level period import), PDF export pipeline (`reportlab` vs `weasyprint` vs server-side puppeteer — `agent-safety-officer` review almost certainly required), inferred-category heuristic (or stay deferred), and the BLG-0013 `tzdata` codification (ADR-0007 amendment vs new ADR). Output: 3+ ADRs, 1+ DES, ≥ 3 Ready BLGs for S-006 implementation. No production code changed in discovery. See `docs/plan.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
